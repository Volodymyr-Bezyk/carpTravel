...
const Home = () => (
  <main>
    ...
    >
      <Container>
        <div className='tablet:flex tablet:justify-between tablet:mb-9'>
          <h2 className=" mb-6  uppercase text-40 font-thin leading-snug -tracking-1.6 tablet:mb-0  tablet:text-67 tablet:-tracking-2.68  desktop:text-98 desktop:-tracking-3.92">
            WE <strong className=" font-medium">OFFER</strong>
          </h2>
          <p className=" mb-4 text-43 font-thin leading-normal text-right tablet:pr-14 tablet:text-67 tablet:leading-tight desktop:pr-368px desktop:text-98 desktop:leading-normal">
        ...
        <div className=' tablet:flex tablet:justify-between'>
          ...
          <div className='tablet:w-220px tablet:flex tablet:flex-col desktop:w-606px desktop:h-484px desktop:flex-wrap'>
            <p className="opacity-50 mt-3 mb-6 text-right text-xs font-extralight leading-6 tracking-2.4 tablet:mt-0 tablet:mb-8 tablet:text-left desktop:w-294px desktop:mb-auto">
              Feel the adrenaline rush
            </p>

            <ul className='grid gap-4 w-44 mb-9 tablet:order-first tablet:mb-6 desktop:w-64 desktop:gap-6 desktop:mb-230px '>
              <li>
                <button className='activeService uppercase text-left opacity-50 text-xl font-extralight leading-0.85 tablet:text-22px desktop:text-28 desktop:leading-6 ' type='button' >ATVs Traveling</button>
              </li>
              <li>
                <button className=' uppercase text-left opacity-50 text-xl font-extralight leading-0.85 tablet:text-22px desktop:text-28 desktop:leading-6' type='button'>Rock climbing</button>
              </li>
              <li>
                <button className=' uppercase text-left opacity-50 text-xl font-extralight leading-0.85 tablet:text-22px desktop:text-28 desktop:leading-6' type='button'>Hot air ballooning</button>
              </li>
              <li>
                <button className=' uppercase text-left opacity-50 text-xl font-extralight leading-0.85 tablet:text-22px desktop:text-28 desktop:leading-6' type='button'>Skydiving</button>
              </li>
              <li>
                <button className=' uppercase text-left opacity-50 text-xl font-extralight leading-0.85 tablet:text-22px desktop:text-28 desktop:leading-6' type='button'>Rafting</button>
              </li>
            </ul>

            <p className=' opacity-50 text-sm font-extralight leading-5 tablet:text-13 tablet:text-justify desktop:w-294px desktop:text-lg desktop:leading-6'>Join exciting rafting expeditions on the waterways of the Carpathians. Go through challenging waterways and overcome gusty waves, feel the adrenaline, and enjoy the incredible views of the surrounding mountains.</p>
      ...
      <Container>
        ...
        <div className=" tablet:flex ">
          ...
          <form className="tablet:flex tablet:flex-col tablet:flex-wrap tablet:h-408px tablet:w-220px tablet:content-between desktop:h-466px desktop:w-72 desktop:-translate-y-86px">
            ...
            <button
              className=" ml-auto block w-20 uppercase text-3xl font-normal leading-normal hover:text-mainBtnBgHover transition-colors duration-300 tablet:order-2 tablet:w-auto desktop:text-32"
              type="submit"
    ...
    >
      <Container>
        <h2 className=" mb-6 uppercase text-40 font-thin leading-snug -tracking-1.6 tablet:mb-72px tablet:text-center tablet:text-67 tablet:leading-tight tablet:-tracking-2.68 desktop:mb-6 desktop:text-98 desktop:leading-normal desktop:tracking-3.92 desktop:text-left">
    ...
    >
      <Container>
        <h2 className=" mb-9 uppercase text-40 font-thin leading-snug -tracking-1.6 tablet:mb-9 tablet:text-67 tablet:leading-none tablet:-tracking-2.68 desktop:mb-71px desktop:text-98 desktop:leading-normal desktop:tracking-3.92">
        ...
        <div className=" desktop:flex desktop:items-start desktop:justify-between">
          <div className=" tablet:flex tablet:flex-col tablet:flex-wrap tablet:h-104px tablet:items-end tablet:content-around tablet:mb-16 desktop:flex-nowrap">
            <div className=" mb-6 flex justify-end items-baseline desktop:mb-16 ">
              <div className=" mr-5">
                <a
                  className=" block text-sm leading-6 tablet:text-base desktop:text-lg desktop:leading-6"
            ...
            <div className=" mb-3 flex justify-end items-baseline tablet:mb-0 tablet:ml-90px">
              ...
              <ul>
                <li className="w-86px desktop:text-right">
                  <a
                    className="footerSocialLink tablet:text-base desktop:text-lg desktop:leading-6  "
                    href="/"
                    rel="noopener noreferrer nofollow"
                    target="_blank"
          ...
          <form className="tablet:flex tablet:flex-col tablet:flex-wrap tablet:h-305px desktop:flex-row desktop:h-auto desktop:w-606px ">
            ...
            <label className=" mb-4 block tablet:ml-5 tablet:w-463px tablet:h-244px desktop:ml-0 desktop:w-606px desktop:mt-10   ">
              ...
              <textarea className=" px-2 h-196px resize-none bg-inputBg w-full text-13 font-extralight leading-6 outline-none tablet:h-220px desktop:text-xl desktop:leading-6 desktop:py-2px" />
            </label>

            <button
              className=" ml-auto block w-20 uppercase text-3xl font-normal leading-normal hover:text-mainBtnBgHover transition-colors duration-300 tablet:w-auto desktop:text-32"
              type="submit"
              aria-label="Submit form button"
            >
              send
